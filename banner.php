...
<body>
  ...
  <div id="slider" class="nivoSlider">
                <img style="background-color:white;"src="images/simple_img_1.jpg" data-thumb="images/simple_img_1.jpg" alt="" />
                <img style="background-color:white;"src="images/simple_img_2.jpg" data-thumb="images/simple_img_2.jpg" alt="" />
    ...
    <!--<div class="reignSoftHeaderBanner">
      <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="959" height="244">
        ...
        <!--[if !IE]>-->
        <!--<object type="application/x-shockwave-flash" data="cu3er.swf" width="959" height="244">
          <!--<![endif]-->
          <!--<param name="quality" value="high" />
          <!--<param name="wmode" value="opaque" />
          <param name="swfversion" value="9.0.45.0" />
